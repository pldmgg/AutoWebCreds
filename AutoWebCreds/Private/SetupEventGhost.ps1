function SetupEventGhost {
    ...
    $EventGhostConfigFile = $($PSScriptRoot | Split-Path -Parent) + '\' + 'EventGhost' + '\' + 'ConfigurationFiles' + '\' + 'eventghosttreett.xml'
    #cmd /c "`"$EventGhostPath`" -file `"$EventGhostConfigFile`""
    Start-Process -FilePath $EventGhostPath -ArgumentList "-file `"$EventGhostConfigFile`""
}

# SIG # Begin signature block
# MIIMaAYJKoZIhvcNAQcCoIIMWTCCDFUCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUMapfDoElY6CDDUOZPGl9dc/g
# LqKgggndMIIEJjCCAw6gAwIBAgITawAAAERR8umMlu6FZAAAAAAARDANBgkqhkiG
...
# BDEWBBRMsqntKT2jwEUFBAQdbYqxPr1GRjANBgkqhkiG9w0BAQEFAASCAQB8yl1+
# NGgW6jlA+U46wxymNtz/xNdUD8oUDXSB82dc3LZE3jh1BtL2V4S4B3/eaCXF3FLB
# GmAdNreiZzXva/XHVoExAHW0IldFoFwBNmr4gMKPE74pxoPL0QCfugCMo+UkFK6Z
# A1RUYwNez0QWukAWoUJtR99pmQK0NHl9/SrQDnevOi7zk0ddPyZclITf+YZBkFQ0
# KZe40IZlNd6KI8pis82CQnJMrrnDudgitM1cp0jCqNQ3/hsNTDDMfRo/H0XtSDcP
# jA63HKQDW7APyudgJikXvOaxyQUNJTiaMEfQvOufyTmGB6NYBCGr+TQ/8M/F4sZX
# Un+o6hGJiQEeNRDf
